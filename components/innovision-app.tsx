...
function Nav() {
  ...
  const links: [string, string][] = [['About', '#about'], ['Contact Us', '/contact'], ['Schedule', '#schedule'], ['Moments', '#moments']];
...
function Footer() {
  return <footer className="site-footer"><div className="footer-cta"><Reveal><h2 className="footer-headline">See you at <em>Innovision.</em></h2><a className="button button-primary" href="#register">Register now <ArrowUpRight size={17} /></a></Reveal></div><div className="footer-top"><Logo /><p>Two days. One campus.<br /><span>Infinite ways forward.</span></p><a className="footer-mail" href={`mailto:${event.email}`}>{event.email} <ArrowUpRight size={15} /></a></div><div className="footer-bottom"><span>© 2027 Innovision, NSUT</span><div className="socials"><a href={event.socials.instagram} aria-label="Instagram" rel="noopener noreferrer"><Camera size={17} /></a><a href={event.socials.linkedin} aria-label="LinkedIn" rel="noopener noreferrer"><BriefcaseBusiness size={17} /></a><a href={event.socials.facebook} aria-label="Facebook" rel="noopener noreferrer"><span className="facebook-icon">f</span></a></div><a className="contact-footer-link" href="/contact">Contact Us <ArrowUpRight size={14} /></a><span>Built as an Enactus R2 Tech Task prototype.</span></div></footer>;
}
